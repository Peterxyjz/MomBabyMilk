...
import { RiListIndefinite, RiArticleLine, RiCoinsLine, RiContactsLine, RiCoupon2Line, RiCurrencyFill, RiExchangeDollarFill, RiHomeLine, RiImageLine, RiListUnordered, RiPagesLine, RiPercentLine, RiQuestionnaireLine, RiRefund2Line, RiSettings3Line, RiStore2Line, RiStore3Line, RiTruckLine, RiWalletLine, RiWindowLine } from "react-icons/ri";
...
const MENUITEMS = [
  ...
  },
  {
    ...
    type: "link",
    path: "/user",
    permission: ["user.index", "user.create", "user.edit", "user.destroy"],
    role: "admin",
    // children: [
  ...
  },
  {
    ...
    type: "link",
    path: "/product",
    permission: ["product.index","product.create","product.edit","product.destroy"],
    role: "staff",
    // children: [
  ...
  },
  {
    ...
    type: "link",
    path: "/tag",
    permission: ["tag.index", "tag.create", "tag.edit", "tag.destroy"],
    role: "staff",
  },
  // {
  //   title: "Stores",
