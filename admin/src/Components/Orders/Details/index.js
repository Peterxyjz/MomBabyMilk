    ...
    return (
        <Row>
            <Col xxl="9">
                ...
                <Col sm="12">
                    <OrderNumberTable moduleName={`${t('OrderNumber')}: #${data?.order_number}`} data={data} orderStatusData={orderStatusData} setOrderStatus={setOrderStatus} orderStatus={orderStatus} edit={true} />
                </Col>
