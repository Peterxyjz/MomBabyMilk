        ...
        <Formik
            ...
            {({ values, setFieldValue, errors }) => (
                <Form className="theme-form theme-form-2 mega-form row">
                    ...
                    <SimpleInputField nameList={[{ name: 'name', title: 'Name', require: "true", placeholder: "Nhập tên" }]} />
                    <SimpleInputField nameList={[{ name: 'email', title: 'Email', require: "true", placeholder: "Nhập email" }]} />
